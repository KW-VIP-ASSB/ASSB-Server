...
from handsome.schema import HandsomeStyleInfo
...
class HandsomeLoadInfoOperator(BaseOperator):
    ...
    def execute(self, context: Context):
        ...
        results = [ HandsomeStyleInfo.model_validate(result) for result in results ]
